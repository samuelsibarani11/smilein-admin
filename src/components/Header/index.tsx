...
import LogoIcon from '../../images/logo/SmileIn-Logo-White.png';
      ...
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 block bg-white p-1.5  dark:border-strokedark dark:bg-boxdark lg:hidden"
          >
        ...
        {/* <!-- User Components Area - Right aligned --> */}
