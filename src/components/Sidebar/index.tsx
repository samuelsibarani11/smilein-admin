...
import logo from '../../images/logo/sendir-logo.png'
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link to="/" className="block">
          <div className="flex items-center justify-between px-5 gap-6">
            <img src={logo} alt="sendir-logo" className='w-10' />
            <p className="text-2xl text-white font-bold">Sendir</p>
          </div>
        </Link>
        ...
        <nav className="py-4 px-4 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/student/student-registration"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/academic' || pathname.includes('forms')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        >
                          ...
                          <path d="M4 19h4c1.1 0 2-.9 2-2v-1" />
                        </svg>
                        Academic
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/attendance' || pathname.includes('forms')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/schedule' || pathname.includes('forms')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/notification' || pathname.includes('forms')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/notification/notification-history"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink
                              to="/notification/notification-templates"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/settings' || pathname.includes('forms')
                }
              >
                {(handleClick, open) => {
                  return (
